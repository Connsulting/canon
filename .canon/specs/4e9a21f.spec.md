...
3. Split SQL into statements by semicolon and strip `--` and `/* */` comments before matching.
...
Introduce an offline schema migration analyzer for deterministic breaking-change detection.
