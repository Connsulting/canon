...
domain: privacy
created: 2026-03-07T08:35:22Z
depends_on: [9ad4f11]
touched_domains: [analysis, privacy]
---
...
1. `privacy-check` findings are static assertions over scanned file content and do not imply runtime behavior.
2. Severity threshold failures (`--fail-on`) are treated as command failure conditions for CI/CD usage.
...
Add a privacy policy consistency checker command.
